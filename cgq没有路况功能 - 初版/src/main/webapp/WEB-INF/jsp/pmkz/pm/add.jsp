       ...
       <table style="table-layout:fixed;height: 50px">
           <tr>
               ...
               <td style="width:360px;">    
                   <input name="ip" class="mini-textbox" style="width:300px;" required="true"/>
               </td>
           </tr>
           <tr>
               <td style="width:120px;">端口：</td>
               <td style="width:360px;">    
                   <input name="dk" class="mini-textbox" style="width:300px;" required="true"/>
               </td>
           </tr>
           <tr>
           ...
           <tr>
               <td style="width:120px;">布站位置：</td>
               <td style="width:360px;">    
                   <input name="bzwz" class="mini-textbox" style="width:300px;"/>
               </td>
           </tr>
           <tr>
               <td style="width:120px;">屏幕类型：</td>
               <td style="width:360px;">  
                   <input name="pmlx" class="mini-combobox" valueField="value" textField="text" style="width:300px;"
                      url="<%=request.getContextPath() %>/common/getDictItemByTypeCode.do?typeCode=100004" required="true"/>      
               </td>
           </tr>
       </table>
    </div>
...
<script type="text/javascript">
    ...
    function SetData(data) {
        if (data.action == "edit") {
            ...
            $.ajax({
            	url: HOST_URL+"/pmkz/pm/getById.do?id="+data.id,
                cache: false,
                success: function (text) {
