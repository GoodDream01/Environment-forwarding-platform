...
<!-- 	                        <a class="mini-button" iconCls="icon-add" onclick="add()" plain="true" tooltip="增加...">增加</a>
	    ...
	    <div class="mini-fit" >
		    ...
		    <div id="datagrid1" class="mini-datagrid"  style="width:100%;height:100%;"  allowResize="true"
		      ...
		      url="<%=request.getContextPath() %>/hygl/hyxttz/getList.do" idField="zid" multiSelect="true" 
		    ...
		    >
		        <div property="columns">
		            ...
		            <div field="ztznr" width="350" allowSort="false" headerAlign="center" align="center">通知内容</div>   
		            <div field="zjszt" width="100" headerAlign="center" align="center" allowSort="false" renderer="onFsztRenderer">接收状态</div>                          
		            <div field="zjssj" width="130" allowSort="false" headerAlign="center" align="center" dateFormat="yyyy-MM-dd HH:mm:ss">接收时间</div>                                    
		            <div field="zlrsj" width="130" headerAlign="center" align="center" allowSort="true" dateFormat="yyyy-MM-dd HH:mm:ss">录入时间</div>
	...
	function add() {
		var title="会议文件添加";
        mini.open({
            url: HOST_PATH + "/hygl/hydxtz/addUi.do",
    ...
    function edit() {
        ...
        if (row) {//alert(row.ZID+":"+row.ZFID);
            mini.open({
            	url: HOST_PATH + "/hygl/hydxtz/addUi.do",
                title: "会议文件修改", width: 600, height: 300,
                loadOnRefresh: true,
                onload: function () {
                    var iframe = this.getIFrameEl();
    ...
    function fstz() {
        ...
        if (row) {//alert(row.ZID+":"+row.ZFID);
            mini.open({
            	url: HOST_PATH + "/hygl/hyxttz/addUi.do",
                title: "会议通知详情", width: 820, height: 300,
                loadOnRefresh: true,
                onload: function () {
                    var iframe = this.getIFrameEl();
                    var data = { action: "edit", id: row.zid };
    ...
    function onCzRenderer(e) {
    	var html = "";
    	html += "<a class=\"mini-button\" style=\"width:60px;\" onclick=\"fstz()\">查看</a>";
        return html;
    }
    ...
    var yhzts = <%=DictUtils.ItemToKeyValue(DictTypeEnum.PUB_HY_HYTZ_JSZT.toString())%>;
    function onFsztRenderer(e){
		var html = yhzts[e.value];
		if(e.value=="0"){
