...
<!-- 	                        <a class="mini-button" iconCls="icon-add" onclick="add()" plain="true" tooltip="增加...">增加</a>
	    ...
	    <div class="mini-fit" >
		    ...
		    <div id="datagrid1" class="mini-datagrid"  style="width:100%;height:100%;"  allowResize="true"
		      ...
		      url="<%=request.getContextPath() %>/hygl/hydxtz/getList.do" idField="zid" multiSelect="true" 
		    ...
		    >
		        <div property="columns">
		            ...
		            <div field="zdxnr" width="350" allowSort="false" headerAlign="center" align="center">短信内容</div>   
		            <div field="zfszt" width="100" headerAlign="center" align="center" allowSort="false" renderer="onFsztRenderer">发送状态</div>                          
		            <div field="zfssj" width="130" allowSort="false" headerAlign="center" align="center" dateFormat="yyyy-MM-dd HH:mm:ss">发送时间</div>                                    
    ...
    function fstz() {
        ...
        if (row) {//alert(row.ZID+":"+row.ZFID);
            mini.open({
            	url: HOST_PATH + "/hygl/hydxtz/addUi.do",
                title: "短信通知详情",width: 820, height: 300,
                loadOnRefresh: true,
                onload: function () {
                    var iframe = this.getIFrameEl();
                    var data = { action: "edit", id: row.zid };
    ...
    var yhzts = <%=DictUtils.ItemToKeyValue(DictTypeEnum.PUB_HY_DX_FSZT.toString())%>;
    function onFsztRenderer(e){
		var html = yhzts[e.value];
		if(e.value=="0"){
			html = "<font color='red'>"+html+"</font>";
		}else if(e.value=="2"){
			html = "<font color='yellow'>"+html+"</font>";
		}
    	return html;
    }
