...
<div class="mini-layout" style="width:100%;height:100%;">
    <div title="center" region="center" style="border:0;">
	    ...
	    <div class="mini-fit" >
		    ...
		    <div id="datagrid1" class="mini-datagrid"  style="width:100%;height:100%;"  allowResize="true"
		      ...
		      url="<%=request.getContextPath() %>/hygl/hygl/getList.do" idField="zid" multiSelect="true" 
		    ...
		    >
		        <div property="columns">
		            ...
		            <div field="" width="350" headerAlign="center" align="center" allowSort="true" renderer="onCzRenderer">操作</div>
		        </div>
		    </div>
	    </div>
    </div>
    ...
    function onCzRenderer(e) {
    	...
    	html += "<a class=\"mini-button\" style=\"width:100px;\" onclick=\"hyqd()\">签到投屏</a>";
        return html;
    }
