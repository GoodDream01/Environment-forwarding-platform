	    ...
	    <div class="mini-fit" >
		    ...
		    >
		        <div property="columns">
		            ...
		            <div field="" width="230" headerAlign="center" align="center" allowSort="true" renderer="onCzRenderer">操作</div>
		        </div>
		    </div>
	    </div>
    </div>
    ...
    function view() {
        ...
        if (row) {//alert(row.ZID+":"+row.ZFID);
            mini.open({
                ...
                title: "分组讨论查看", width: 800, height: 660,
                loadOnRefresh: true,
                onload: function () {
                    var iframe = this.getIFrameEl();
...
//             return;
    ...
    function xgxx() {
        ...
        if (row) {//alert(row.ZID+":"+row.ZFID);
        	mini.open({
               	url: HOST_PATH + "/hygl/wdfz/wj/listUi.do?zfzid="+row.zid,
                   title: "文件管理", width: '95%', height: '95%',
                   loadOnRefresh: true,
                   onload: function () {
    ...
    function onCzRenderer(e) {
    	...
    	html += "<a class=\"mini-button\" style=\"width:60px;\" onclick=\"xgxx()\">相关文件</a>";
        return html;
    }
