	            ...
	            <div style="padding:5px;">
		            ...
		            <table style="table-layout:fixed;">
		                ...
		                <tr>
		                    ...
		                    <td colspan="5">    
		                        <input name="ztznr" class="mini-textarea" required="true" maxLength="70" style="width: 665px;"/>
		                    </td>
		                </tr>
		                <tr>
		                ...
		                <tr>
		                    <td class="addBt" >通知内容：</td>
		                    <td colspan="5">    
		                        <input name="ztznr2" class="mini-textarea" required="true" maxLength="70" style="width: 665px;"/>
		                    </td>
		                </tr>
