...
<div class="mini-layout" style="width:100%;height:100%;">
    <div title="center" region="center" style="border:0;">
	    ...
	    <div class="mini-fit" >
		    ...
		    <div id="datagrid1" class="mini-datagrid"  style="width:100%;height:100%;"  allowResize="true"
		      ...
		      url="<%=request.getContextPath()%>/hcgl/hcsb/getList.do" idField="id" multiSelect="true" 
			  fitColumns="false" pageSize="20">
		        <div property="columns">
		            ...
		            <div field="zhcid" width="120" headerAlign="center" align="center" allowSort="true"  required="true">会场</div> 
		            <div field="zsbbh" width="120" headerAlign="center" align="center" allowSort="true"  required="true">设备编号</div> 
		            <div field="zsbmc" width="80" headerAlign="center" align="center" allowSort="true" >设备名称</div>    
		            <div field="zsblx" width="150" headerAlign="center" align="center" allowSort="true" >设备类型</div> 
		            <div field="zsort" width="150" headerAlign="center" align="center" allowSort="true" >排序号</div> 
	...
	function add() {
		var title="请假申请";
        mini.open({
            url: HOST_PATH + "/hcgl/hcsb/addUi.do",
            title: title, width: 500, height: 700,
            loadOnRefresh: true,
            showMaxButton: true, 
            onload: function () {
    ...
    function xiaojia1() {
        ...
        if (row) {//alert(row.ZID+":"+row.ZFID);
            mini.open({
            	url: HOST_PATH + "/qjgl/qj/xiaoJia.do",
                title: "销假", width: 350, height: 300,
                loadOnRefresh: true,
                onload: function () {
                    var iframe = this.getIFrameEl();
                   
                    var data = { action: "xj", zid:row.zid };
                    iframe.contentWindow.SetData(data);
    ...
    function deloneDo(){
        ...
        if (row) {//alert(row.ZID+":"+row.ZFID);
            ...
            $.ajax({
                url: HOST_URL+"/hcgl/hcsb/delete.do?id="+row.zid,
    			type: 'post',
    		    dataType: 'json',
    ...
    function onCzRenderer(e) {
    	var html = "";
    	html += "<a class=\"mini-button\" style=\"width:60px;\" onclick=\"edit()\">编辑</a><a class=\"mini-button\" style=\"width:60px;\" onclick=\"xiaojia()\">销假</a>";
        return html;
    }
    ...
    function onStatusRenderer1(e){
    	if(e.value=="0"){
    		return "<font color='red'>未销假 </font>";
    	}
    	if(e.value=="1"){
    		return "<font color='green'>销假 </font>";
    	}
