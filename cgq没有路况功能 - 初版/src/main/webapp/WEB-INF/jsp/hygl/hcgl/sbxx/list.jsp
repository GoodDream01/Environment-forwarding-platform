...
<div class="mini-layout" style="width:100%;height:100%;">
    <div title="center" region="center" style="border:0;">
	    <div style="width:100%;">
		    <div class="mini-toolbar" style="text-align:center;" borderStyle="border:1;border-bottom:0;">
		        ...
		        <label >设备名称：</label>
                  <input id="zsbmc"  name="zsbmc"   class="mini-textbox" />
	    ...
	    <div class="mini-fit" >
		    ...
		    <div id="datagrid1" class="mini-datagrid"  style="width:100%;height:100%;"  allowResize="true"
		      ...
		      url="<%=request.getContextPath()%>/hcgl/sbxx/getList.do" idField="id" multiSelect="true" 
			  fitColumns="false" pageSize="20">
		        <div property="columns">
		            ...
		            <div field="zsblx" width="150" headerAlign="center" align="center" allowSort="true" renderer="onTypeRenderer" >设备类型</div>
		            <div field="zlrsj" width="150" headerAlign="center" align="center" allowSort="true" renderer="onLrsjRenderer">录入时间</div>  
    ...
    function search() {
    	var o={};
        var zsbmc =  mini.get("zsbmc").getValue();
        o.zsbmc = zsbmc;
	...
	function add() {
		var title="添加";
        mini.open({
            url: HOST_PATH + "/hcgl/sbxx/addUi.do",
    ...
    function deloneDo(){
        ...
        if (row) {//alert(row.ZID+":"+row.ZFID);
            ...
            $.ajax({
                url: HOST_URL+"/hcgl/sbxx/delete.do?zid="+row.zid,
    			type: 'post',
    		    dataType: 'json',
