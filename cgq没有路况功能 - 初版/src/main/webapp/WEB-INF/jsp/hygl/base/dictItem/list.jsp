    ...
    <div title="center" region="center" style="border:0;">
	    ...
	    <div class="mini-fit" >
		    ...
		    <div id="datagrid1" class="mini-datagrid"  style="width:100%;height:100%;"  allowResize="true"
		      ...
		      url="<%=request.getContextPath() %>/base/dictItem/getList.do" idField="id" multiSelect="true" 
			  fitColumns="false" pageSize="20"
		    >
		        <div property="columns">
		                    
		            <div field="jgid" type="checkcolumn" ></div>        
		            <div type="indexcolumn" width="40" headerAlign="center" align="center">序号</div>
		            <div field="value" width="80" headerAlign="center" align="center" allowSort="true" >字典值</div>        
		            <div field="text" width="150" headerAlign="center" align="center" allowSort="true" >字典文本</div> 
		            <div field="typeCode" width="150" headerAlign="center" align="center" allowSort="true" renderer="onTypeCodeRenderer">字典类型</div> 
		            <div field="status" width="80" headerAlign="center" align="center" allowSort="true" renderer="onStatusRenderer">状态</div>
