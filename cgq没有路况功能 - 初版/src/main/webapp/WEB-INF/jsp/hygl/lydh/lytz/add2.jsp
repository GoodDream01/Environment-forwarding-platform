	            ...
	            <div style="padding:5px;">
		            ...
		            <table style="table-layout:fixed;">
		                ...
		                <tr>
		                    ...
		                    <td colspan="5">    
		                        <input name="ztext" class="mini-textarea" required="true" maxLength="60" style="width: 665px;"/>
		                    </td>
		                </tr>
		                <tr>
		            ...
		            <table style="table-layout:fixed;" cellpadding="0" cellspacing="0">
		                <tr>
					        ...
					        <fieldset style="border:solid 1px #aaa;padding:3px;">
					            ...
					            <div style="padding:5px;">
					            <!-- ////////////////////////////////////////////////////////////// -->
					            <div class="mini-fit" style="width:365px;height:300px;">
					            	<!--
								    <div style="width:100%;">
								    ...
								    >
								        <div property="columns">
								            ...
								            <div field="zdhhm" width="100" headerAlign="center" align="center" allowSort="false">电话号码</div>                                                            
