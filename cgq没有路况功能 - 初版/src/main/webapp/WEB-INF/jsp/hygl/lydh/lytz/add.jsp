...
<body>
    <form id="form1" method="post">
        ...
        <input name="zurl" class="mini-hidden" />
		            ...
		            <table style="table-layout:fixed;" cellpadding="0" cellspacing="0">
		                <tr>
					        ...
					        <fieldset style="border:solid 1px #aaa;padding:3px;">
					            ...
					            <div style="padding:5px;">
					            <!-- ////////////////////////////////////////////////////////////// -->
					            <div class="mini-fit" style="width:178px;height:300px;">
					            	<!--
								    <div style="width:100%;">
								    ...
								    >
								        <div property="columns">
								            ...
								            <div field="zryxm" width="90" headerAlign="center" align="center" allowSort="false">姓名</div>
								            <div field="zdhhm" width="100" headerAlign="center" align="center" allowSort="false" visible="false">电话号码</div>                                                            
								            <div field="" width="50" type="checkcolumn" ></div>
								            <div field="" ></div>
					        ...
					        <fieldset style="border:solid 1px #aaa;padding:3px;">
					            ...
					            <div class="mini-fit" style="width:178px;height:300px;">
									...
									-->
								    <div id="partymassGrid" class="mini-datagrid" style="width:100%;height:300px;"
								        allowResize="false" showPager="false" idField="id" 
								        allowCellEdit="true" allowCellSelect="true" multiSelect="true"
								        url="<%=request.getContextPath() %>/base/partymass/getList.do" 
								    >
								        <div property="columns">
								        	<div type="indexcolumn" width="30"></div>
								            <div field="zid" visible="false" ></div> 
								            ...
								            <div field="zname" width="90" headerAlign="center" align="center" allowSort="false">姓名</div>    
								            <div field="zdhhm" width="100" headerAlign="center" align="center" allowSort="false" visible="false">电话号码</div>                                                          
								            <div field="" width="50" type="checkcolumn" ></div>
								            <div field="" ></div>
					        ...
					        <fieldset style="border:solid 1px #aaa;padding:3px;">
					            ...
					            <div class="mini-fit" style="width:178px;height:300px;">
									...
									-->
								    <div id="mediaGrid" class="mini-datagrid" style="width:100%;height:300px;"
								        allowResize="false" showPager="false" idField="id" 
								        allowCellEdit="true" allowCellSelect="true" multiSelect="true"
								        url="<%=request.getContextPath() %>/base/media/getList.do" 
								    >
								        <div property="columns">
								        	<div type="indexcolumn" width="30"></div>
								            <div field="zid" visible="false" ></div> 
	...
	var partymassGrid = mini.get("partymassGrid");
	partymassGrid.load();
	
	var mediaGrid = mini.get("mediaGrid");
	mediaGrid.load();   
    ...
    function SaveData() {
        ...
        console.log(json);
        $.ajax({
            url: HOST_URL+"/hygl/lydhcall/save.do",
			type: 'post',
		    dataType: 'json',
    ...
    function SetData(data) {
        ...
        if (data.action == "view") {
            ...
            $.ajax({
            	url: HOST_URL+"/hygl/lydhhc/getById.do?isshowry=1&id="+data.id,
                cache: false,
                success: function (text) {
                    var o = mini.decode(text);
                    form.setData(o);
                    mini.getByName("zhymc").setValue(o.hyinfo.zhymc);
                    
                    playSound("player",o.zurl,false);
                    
                    //填充政协常委
                    var committee = o.hyinfo.committee;
                    setCommitteeData(committee);
                    
                    //填充工作人员
                    var operator = o.hyinfo.operator;
