    ...
    <div title="center" region="center" style="border:0;">
	    ...
	    <div class="mini-fit" >
		    <div id="datagrid1" class="mini-datagrid" style="width:100%;height:100%;" allowResize="true"
		      url="<%=request.getContextPath() %>/cgq/rygl/getList.do" idField="id" multiSelect="true" 
			  fitColumns="false" pageSize="20">
		        <div property="columns">
		            ...
		            <div field="name" width="300" headerAlign="center" align="center">姓名</div>        
		            <div field="phone" width="300" headerAlign="center" align="center">电话</div> 
		            <div field="qymc" width="300" headerAlign="center" align="center">所属区域</div> 
		            <div field="" width="300" headerAlign="center" align="center" renderer="onCzRenderer">操作</div>
		        </div>
		    </div>
	    </div>
    </div>
...
<script type="text/javascript">
    ...
    function search() {
       ...
       o.name = mini.getByName("name").getValue();
       grid.load(o);
    }
	...
	function add() {
		mini.open({
    		url: HOST_PATH + "/cgq/rygl/addUi.do",
    ...
    function deloneDo(){
        ...
        if (row) {
            $.ajax({
                url: HOST_URL+"/cgq/rygl/delete.do?id="+row.id,
    			type: 'post',
    		    dataType: 'json',
