...
<body>
    <form id="form1" method="post">
        <input name="id" class="mini-hidden" />
       	<input name="pid" class="mini-hidden" style="width:330px;" required="true" />
        <div style="padding-left:11px;padding-bottom:5px;padding-top: 10px">
            <table style="table-layout:fixed;height: 50px">
                ...
                <tr>
                    ...
                    <td style="width:350px;">    
                    	<input name="bz" class="mini-textbox" style="width:300px;"/>
                    </td>
                </tr>
            </table>
        </div>
    ...
    function SetData(data) {
        ...
        if (data.action == "edit") {
            ...
            $.ajax({
            	url: HOST_URL+"/cgq/area/getById.do?id="+data.id,
                cache: false,
                success: function (text) {
