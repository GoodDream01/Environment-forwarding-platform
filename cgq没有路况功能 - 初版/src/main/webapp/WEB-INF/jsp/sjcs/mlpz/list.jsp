    ...
    <div title="center" region="center" style="border:0;">
	    ...
	    <div class="mini-fit" >
		    <div id="datagrid1" class="mini-datagrid" style="width:100%;height:100%;" allowResize="true"
		      url="<%=request.getContextPath() %>/sjcs/mlpz/getList.do" idField="id" multiSelect="true"
			  fitColumns="false" pageSize="20">
		        <div property="columns">
					...
					<div field="sbid" width="100" headerAlign="center" align="center">设备编号</div>
		            <div field="value" width="100" headerAlign="center" align="center">下发命令</div>
					<div field="text" width="180" headerAlign="center" align="center">下发命令</div>
					<!-- 修改显示指定时间 -->>
				    <div field="zdsj" width="180" headerAlign="center" align="center" dateFormat="yyyy-MM-dd HH:mm:ss">指定时间</div>
					<div field="ym" width="150" headerAlign="center" align="center">域名</div>
					<div field="dk" width="150" headerAlign="center" align="center">端口</div>
		            <div field="xtsj" width="200" headerAlign="center" align="center" dateFormat="yyyy-MM-dd HH:mm:ss">创建时间</div>
		        </div>
		    </div>
	    </div>
    </div>
...
<script type="text/javascript">
	...
	function add() {
		mini.open({
    		url: HOST_PATH + "/sjcs/mlpz/addUi.do",
    ...
    function deloneDo(){
        ...
        if (row) {
            $.ajax({
                url: HOST_URL+"/sjcs/mlpz/delete.do?id="+row.id,
    			type: 'post',
    		    dataType: 'json',
