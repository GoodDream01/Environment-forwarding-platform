	...
	<div title="center" region="center" style="border:0;">
		...
		<div class="mini-fit" >
			<div id="datagrid1" class="mini-datagrid" style="width:100%;height:100%;" allowResize="true"
				 url="<%=request.getContextPath() %>/sjcs/sjpz/getList.do?sbid=<%=request.getParameter("sbid")%>" idField="id" multiSelect="true"
...
<script type="text/javascript">
	...
	function tableToExcel() {
		...
		$.ajax({
			url: HOST_URL+"/sjcs/sjpz/findDc.do?sbid=<%=request.getParameter("sbid")%>&kssj="+kssj+"&jssj="+jssj,
			type: 'post',
			dataType: 'json',
