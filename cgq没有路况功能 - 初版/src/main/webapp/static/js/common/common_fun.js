 ...
 */
 var _steps1=[];
 _steps1.push({step:"1",code:"1101",name:"谋划",nameFmt:"谋划",isbr:"0",url:"/xmdb/xmgl/xmmh/viewUi.do?zfid=",url2:"/app/xmgl/xmmh/getById.do?zfid="});
 _steps1.push({step:"2",code:"1201",name:"签约",nameFmt:"签约",isbr:"0",url:"/xmdb/xmgl/xmqy/viewUi.do?zfid=",url2:"/app/xmgl/xmqy/getById.do?zfid="});
/* _steps1.push({step:"3",code:"1301",name:"立项",nameFmt:"立项",isbr:"0",url:"/xmdb/xmgl/xmlx/viewUi.do?zfid=",url2:"/app/xmgl/xmlx/getById.do?zfid="});*/
 //_steps1.push({step:"4",code:"1401",name:"开工前审批",nameFmt:"开工<br/>前审批",isbr:"1",url:"/xmdb/xmgl/xmsp/viewUi.do?zfid=",url2:"/app/xmgl/xmsp/getById.do?zfid="});
 _steps1.push({step:"4",code:"1401",name:"规划许可",nameFmt:"规划<br/>许可",isbr:"1",url:"/xmdb/xmgl/ghxkjd/viewUi.do?zfid=",url2:"/app/xmgl/ghxkjd/getById.do?zfid="});
 _steps1.push({step:"5",code:"1402",name:"建设许可",nameFmt:"建设<br/>许可",isbr:"1",url:"/xmdb/xmgl/jsxkjd/viewUi.do?zfid=",url2:"/app/xmgl/jsxkjd/getById.do?zfid="});
 _steps1.push({step:"6",code:"1403",name:"施工许可",nameFmt:"施工<br/>许可",isbr:"1",url:"/xmdb/xmgl/sgxkjd/viewUi.do?zfid=",url2:"/app/xmgl/sgxkjd/getById.do?zfid="});
 _steps1.push({step:"7",code:"1501",name:"开工",nameFmt:"开工",isbr:"0",url:"/xmdb/xmgl/xmkg/viewUi.do?zfid=",url2:"/app/xmgl/xmkg/getById.do?zfid="});
 _steps1.push({step:"8",code:"1601",name:"建设",nameFmt:"建设",isbr:"0",url:"/xmdb/xmgl/xmjs/viewUi.do?zfid=",url2:"/app/xmgl/xmjs/getById.do?zfid="});
 _steps1.push({step:"9",code:"1701",name:"竣工验收",nameFmt:"竣工<br/>验收",isbr:"1",url:"/xmdb/xmgl/jgysjd/viewUi.do?zfid=",url2:"/app/xmgl/jgysjd/getById.do?zfid="});
 _steps1.push({step:"10",code:"1702",name:"竣工",nameFmt:"竣工",isbr:"0",url:"/xmdb/xmgl/xmjg/viewUi.do?zfid=",url2:"/app/xmgl/xmjg/getById.do?zfid="});
 _steps1.push({step:"11",code:"1801",name:"入统",nameFmt:"入统",isbr:"0",url:"/xmdb/xmgl/xmrt/viewUi.do?zfid=",url2:"/app/xmgl/xmrt/getById.do?zfid="});
 _steps1.push({step:"12",code:"1901",name:"自评",nameFmt:"自评",isbr:"0",url:"/xmdb/xmgl/xmzp/viewUi.do?zfid=",url2:"/app/xmgl/xmzp/getById.do?zfid="});
 var _status1={"1101":"1", "1201":"2" ,"1301":"3" ,"1401":"4" ,"1402":"5" ,"1403":"6" ,"1501":"7", "1601":"8", "1701":"9", "1702":"10", "1801":"11", "1901":"12"};
 var _next_status1={"1101":"1201", "1201":"1401" ,"1401":"1402" ,"1402":"1403" ,"1403":"1501" ,"1501":"1601", "1601":"1701", "1701":"1702", "1702":"1901"};
...
/*	 if(isHasTd && isHasTd=="无"){
	 ...
	 if(steps!=null && steps.length>0){
		 for(var i=0;i<steps.length;i++){
			 ...
			 if(parseInt(st)==4){
				 currentStep = parseInt(nowStep)+2;
			 }
			 var onclick = "";
 ...
 * 计算jss-kssj的时间之间的天数
 */
function GetDiffTsNum(kssj,jssj){
	var d = 0;
	if(kssj && jssj ){
		var m = kssj.getTime();
		var n = jssj.getTime();
 ...
 * @returns {Number}
 */
function GetCqtsNum(data){
	var xmjdzt = data.xmjdzt||'';
	var xmjd = _next_status1[xmjdzt];
	//alert(xmjd);
	//var xmjd =xmjdzt;
	var myDate = new Date();
	var m;
	...
	var jssj = myDate;
	if(xmjd=='1401'){
		kssj = new Date(data.jh_ghxk_jssj);

	}else if(xmjd=='1402'){
		kssj = new Date(data.jh_jsxk_jssj);

	}else if(xmjd=='1403'){
		kssj = new Date(data.jh_sgxk_jssj);

	}else if(xmjd=='1501'){
		kssj = new Date(data.jh_kg_jssj);

	}else if(xmjd=='1601'){
		kssj = new Date(data.jh_js_jssj);

	}else if(xmjd=='1701'){
		kssj = new Date(data.jh_jgys_jssj);

	}else if(xmjd=='1702'){
		kssj = new Date(data.jh_jg_jssj);

	}else if(xmjd=='1901'){
		kssj = new Date(data.jh_zwpj_jssj);

	}
	d = GetDiffTsNum(kssj,jssj);
	d = Math.floor(d);
	return d;
}
...
function GetLjcqtsNum(data){
	...
	var jssj = myDate;
	if(xmjd=='1401'){
		jssj = new Date(data.jh_ghxk_jssj);

	}else if(xmjd=='1402'){
		jssj = new Date(data.jh_jsxk_jssj);

	}else if(xmjd=='1403'){
		jssj = new Date(data.jh_sgxk_jssj);

	}else if(xmjd=='1501'){
		jssj = new Date(data.jh_kg_jssj);

	}else if(xmjd=='1601'){
		jssj = new Date(data.jh_js_jssj);

	}else if(xmjd=='1701'){
		jssj = new Date(data.jh_jgys_jssj);
		
	}else if(xmjd=='1702'){
		jssj = new Date(data.jh_jg_jssj);

	}else if(xmjd=='1901'){
		jssj = new Date(data.jh_zwpj_jssj);
...
function GetCntsNum(data){
	...
	var jssj = myDate;
	if(xmjd=='1401'){
		kssj = new Date(data.jh_ghxk_kssj);
		jssj = new Date(data.jh_ghxk_jssj);

	}else if(xmjd=='1402'){
		kssj = new Date(data.jh_jsxk_kssj);
		jssj = new Date(data.jh_jsxk_jssj);

	}else if(xmjd=='1403'){
		kssj = new Date(data.jh_sgxk_kssj);
		jssj = new Date(data.jh_sgxk_jssj);

	}else if(xmjd=='1501'){
		kssj = new Date(data.jh_kg_kssj);
		jssj = new Date(data.jh_kg_jssj);

	}else if(xmjd=='1601'){
		kssj = new Date(data.jh_js_kssj);
		jssj = new Date(data.jh_js_jssj);

	}else if(xmjd=='1701'){
		kssj = new Date(data.jh_jgys_kssj);
		jssj = new Date(data.jh_jgys_jssj);

	}else if(xmjd=='1702'){
		kssj = new Date(data.jh_jg_kssj);
		jssj = new Date(data.jh_jg_jssj);
 ...
 * @returns {String}
 */
function GetJdmc(xmjdzt){
	var step = getStepObj(xmjdzt);
	if(step){
		return step.name;
	}
	return "";
