...
@Controller
@RequestMapping("/sjcs/mlpz")
public class MlpzController {

	private static Logger logger = Logger.getLogger(MlpzController.class);
	
	@Resource
	private MlpzService service;
	
	@RequestMapping("/listUi")
	public String listUi(){
		return "/sjcs/mlpz/list";
	}
	@RequestMapping("/addUi")
	public String addUi(){
		return "/sjcs/mlpz/add";
	}
	...
	public DataGridReturn getList(HttpServletRequest request,Model model){
		...
		try {
			...
			List<Mlpz> list = service.findByPage(pageBounds);
	...
	@RequestMapping("save")
	@ResponseBody
	public AjaxJson save(@RequestBody Mlpz t){
