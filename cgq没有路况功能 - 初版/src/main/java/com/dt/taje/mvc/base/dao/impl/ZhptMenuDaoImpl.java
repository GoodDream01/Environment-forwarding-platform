...
@Repository
public class ZhptMenuDaoImpl extends CommonDaoImpl implements ZhptMenuDaoI {
	...
	public void insertMenu(HashMap hashMap, Connection conn) throws Exception {
		...
		String sql = "";
		String sqls= "";
		sql="insert into TB_MENU (ROLEID,ROLECODE,ROLENAME,CJSJ)values(";
	...
	public void delMenu(String id, Connection conn) throws Exception {
		...
		String sql = "";
		String sqls= "";
		sql="delete from TB_MENU where ZID='"+id+"'";
	...
	public List getMenuTree() {
		// TODO Auto-generated method stub
		String sql = "select * from TB_MENU where 1=1 order by MLEVE,MORDER ";
		List list = executeJDBCQuery(sql);
	...
	public List getUserMenuTree(String uSERID) {
		// TODO Auto-generated method stub
		//String sql = "select * from TB_MENU where 1=1 and ZID in (select menuid from tb_role_menu where roleid in (select roleid from tb_role_user where userid='"+uSERID+"')) order by MLEVE,MORDER ";
		String sql = "select * from TB_MENU where 1=1  and roleid like '%"+uSERID+"%' and isshow='1'  order by MLEVE,MORDER ";
		List list = executeJDBCQuery(sql);
