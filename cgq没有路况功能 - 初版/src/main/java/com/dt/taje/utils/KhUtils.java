...
public class KhUtils {
	...
	public static int getZbAjNum(String dwbh,String year) {
		...
		try {
			String sql = "select count(1) as num from t_proposal where zid in (select zfid from t_proposalzbdw where zdwbh='"+dwbh+"') and zyear='"+year+"' and zcybs='false' ";
	...
	public static int getHbAjNum(String dwbh,String year) {
		...
		ConnDataBase bean0 = new ConnDataBase();
		try {
			String sql = "select count(1) as num from t_proposal where zid in (select zfid from t_proposalhbdw where zdwbh='"+dwbh+"') and zyear='"+year+"' and zcybs='false' ";
			List list = bean0.executeQuery(sql);
			if(list!=null && list.size()>0){
				Map map = (HashMap)list.get(0);
				String NUM = map.get("NUM").toString();
	...
	public static int getZbFkANum(String dwbh,String year) {
		...
		ConnDataBase bean0 = new ConnDataBase();
		try {
			String sql = "select count(1) as num from t_proposal where zid in (select zfid from t_proposalzbdw where zdwbh='"+dwbh+"' and zid in (select zfid from t_proposaltrack where zfeedbackresult in ('A','B'))) and zyear='"+year+"' and zcybs='false' ";
			List list = bean0.executeQuery(sql);
			if(list!=null && list.size()>0){
				Map map = (HashMap)list.get(0);
				String NUM = map.get("NUM").toString();
	...
	public static int getZbFkANum_A(String dwbh,String year) {
		...
		ConnDataBase bean0 = new ConnDataBase();
		try {
			String sql = "select count(1) as num from t_proposal where zid in (select zfid from t_proposalzbdw where zdwbh='"+dwbh+"' and zid in (select zfid from t_proposaltrack where zfeedbackresult in ('A'))) and zyear='"+year+"' and zcybs='false' ";
			List list = bean0.executeQuery(sql);
			if(list!=null && list.size()>0){
				Map map = (HashMap)list.get(0);
				String NUM = map.get("NUM").toString();
	...
	public static int getZbFkANum_B(String dwbh,String year) {
		...
		ConnDataBase bean0 = new ConnDataBase();
		try {
			String sql = "select count(1) as num from t_proposal where zid in (select zfid from t_proposalzbdw where zdwbh='"+dwbh+"' and zid in (select zfid from t_proposaltrack where zfeedbackresult in ('B'))) and zyear='"+year+"' and zcybs='false' ";
			List list = bean0.executeQuery(sql);
			if(list!=null && list.size()>0){
				Map map = (HashMap)list.get(0);
				String NUM = map.get("NUM").toString();
	...
	public static int getTotalAjNum(String dwbh,String year) {
		...
		ConnDataBase bean0 = new ConnDataBase();
		try {
			String sql = "select count(1) as num from t_proposal where (zid in (select zfid from t_proposalzbdw where zdwbh='"+dwbh+"') or zid in (select zfid from t_proposalhbdw where zdwbh='"+dwbh+"')) and zyear='"+year+"' and zcybs='false' ";
			List list = bean0.executeQuery(sql);
			if(list!=null && list.size()>0){
				Map map = (HashMap)list.get(0);
				String NUM = map.get("NUM").toString();
	...
	public static int getZfajNum(String dwbh,String year) {
		...
		ConnDataBase bean0 = new ConnDataBase();
		try {
			String sql = "select count(1) as num from t_proposal where zid in (select ZPID from T_PROPOSALTRACK where zdwbh='"+dwbh+"' and ZVISITRESULT in ('A','B','C')) and zyear='"+year+"' and zcybs='false' ";
			List list = bean0.executeQuery(sql);
			if(list!=null && list.size()>0){
				Map map = (HashMap)list.get(0);
				String NUM = map.get("NUM").toString();
