<%@page import="com.dt.taje.utils.Tools"%>
<%@page import="com.dt.taje.utils.ComUtils"%>
...
<%
	 ...
	 if(cz==null){
	 	cz = "";
	 }System.out.println(request.getParameter("ZYEAR"));
	 ...
	 if(cz.equals("saveup")) {
		 ...
		 String dayfolder = ZYEAR+"/"+ZFLAG;
         String url="upload/"+dayfolder+"/"; //应保证在根目录中有此目录的存在
         ...
         // 允许上传的文件格式的列表    
         final String[] allowedExt = new String[] { "jpg", "jpeg", "gif","png","xls","doc","docx","ppt","pptx" };      
         ...
         while (fileItr.hasNext()) {    
          ...
          try {    
           // 保存文件    
    		...
    		out.println("{success:true,message:'上传成功',url:'"+picUrl+"',fileName:'"+picname+"',filePath:'"+url+"'}");
