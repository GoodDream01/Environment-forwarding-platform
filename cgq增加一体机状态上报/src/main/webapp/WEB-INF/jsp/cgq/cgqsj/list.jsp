    ...
    <div title="center" region="center" style="border:0;">
	    ...
	    <div class="mini-fit" >
		    <div id="datagrid1" class="mini-datagrid" style="width:100%;height:100%;" allowResize="true"
		      url="<%=request.getContextPath() %>/cgq/cgqsj/getList.do" idField="id" multiSelect="true" 
			  fitColumns="false" pageSize="20" sortMode="client">
		       <div property="columns">
		            ...
		            <div field="time" dataType="date" width="150" headerAlign="center" align="center" allowSort="true" dateFormat="yyyy-MM-dd HH:mm:ss">时间</div>
		            <%}else{%>
...
<script type="text/javascript">
    ...
    function view() {    	
        ...
        if (row) {
            mini.open({
            	url: HOST_PATH + "/cgq/cgqsj/addUi.do",
                title: "图片", width: 800, height: 600,
                loadOnRefresh: true,
                onload: function () {
