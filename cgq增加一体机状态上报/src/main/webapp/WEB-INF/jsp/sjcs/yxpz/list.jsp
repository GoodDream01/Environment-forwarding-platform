    ...
    <div title="center" region="center" style="border:0;">
	    ...
	    <div class="mini-fit" >
		    <div id="datagrid1" class="mini-datagrid" style="width:100%;height:100%;" allowResize="true"
		      url="<%=request.getContextPath() %>/sjcs/yxpz/getList.do" idField="id" multiSelect="true"
			  fitColumns="false" pageSize="20">
		        <div property="columns">
		            ...
		            <%--<div field="yxlx" width="200" headerAlign="center" align="center">邮箱类型</div>--%>
					<div field="yxzh" width="200" headerAlign="center" align="center">邮箱账号</div>
					<%--<div field="yxmm" width="200" headerAlign="center" align="center">邮箱密码</div>--%>
...
<script type="text/javascript">
	...
	function add() {
		mini.open({
    		url: HOST_PATH + "/sjcs/yxpz/addUi.do",
    ...
    function deloneDo(){
        ...
        if (row) {
            $.ajax({
                url: HOST_URL+"/sjcs/yxpz/delete.do?id="+row.id,
    			type: 'post',
    		    dataType: 'json',
