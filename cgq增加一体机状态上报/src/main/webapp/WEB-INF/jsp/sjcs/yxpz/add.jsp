...
<form id="form1" method="post">
    ...
    <div style="padding-left:10px;padding-bottom:5px;padding-top: 10px">
       <table style="table-layout:fixed;height: 50px">
           ...
           <%--<tr>--%>
               <%--<td style="width:100px;">邮箱类型：</td>--%>
               <%--<td style="width:380px;">    --%>
                   <%--<input name="yxlx" class="mini-textbox" style="width:350px;" required="true"/>--%>
               <%--</td>--%>
           <%--</tr>--%>
           <tr>
               <td style="width:100px;">邮箱账号：</td>
               <td style="width:380px;">    
                   <input name="yxzh" class="mini-textbox" style="width:350px;" required="true"/>
               </td>
           </tr>
           <%--<tr>--%>
               <%--<td style="width:100px;">邮箱密码：</td>--%>
               <%--<td style="width:380px;">    --%>
                   <%--<input name="yxmm" class="mini-textbox" style="width:350px;" required="true"/>--%>
               <%--</td>--%>
           <%--</tr>--%>
           <tr>
...
<script type="text/javascript">
    ...
    function SaveData() {
        ...
        $.ajax({
            url: HOST_URL+"/sjcs/yxpz/save.do",
			type: 'post',
		    dataType: 'json',
    ...
    function SetData(data) {
        if (data.action == "edit") {
            ...
            $.ajax({
            	url: HOST_URL+"/sjcs/yxpz/getById.do?id="+data.id,
                cache: false,
                success: function (text) {
