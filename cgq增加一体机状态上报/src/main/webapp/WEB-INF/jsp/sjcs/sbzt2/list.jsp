    ...
    <div title="center" region="center" style="border:0;">
	    ...
	    <div class="mini-fit" >
		    <div id="datagrid1" class="mini-datagrid" style="width:100%;height:100%;" allowResize="true"
		      url="<%=request.getContextPath() %>/sjcs/sbzt2/getList.do" idField="id" multiSelect="true"
...
<%--					<div field="szzt" width="200" headerAlign="center" align="center">数字通道状态</div>--%>
					...
					<div field="tahu" width="100" headerAlign="center" align="center">温湿度</div>
					<div field="pressure" width="100" headerAlign="center" align="center">气压</div>
					<div field="wind" width="100" headerAlign="center" align="center">风</div>
					<div field="rainfall" width="100" headerAlign="center" align="center">雨量</div>
					<div field="radiation" width="100" headerAlign="center" align="center">辐射</div>
					<div field="ultraviolet" width="100" headerAlign="center" align="center">紫外</div>
					<div field="illumination" width="100" headerAlign="center" align="center">光照</div>
					<div field="noise" width="100" headerAlign="center" align="center">噪声</div>
					<div field="pm" width="100" headerAlign="center" align="center">Pm</div>
					...
					<div field="simqd" width="120" headerAlign="center" align="center">SIM卡信号强度</div>
				</div>
		    </div>
	    </div>
    </div>
