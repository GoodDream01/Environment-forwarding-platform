...
<form id="form1" method="post">
    <input name="ip" class="mini-hidden"/>
    <input name="dk" class="mini-hidden"/>
    <input name="dz" class="mini-hidden"/>
...
<script type="text/javascript">
    ...
    function SetData(data) {
    	...
    	mini.getByName("ip").setValue(data.ip);
    	mini.getByName("dk").setValue(data.dk); 
    	mini.getByName("dz").setValue(data.dz); 
    }
