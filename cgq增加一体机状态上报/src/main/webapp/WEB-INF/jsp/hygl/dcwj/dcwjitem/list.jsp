...
String subtopicid = request.getAttribute("subtopicid").toString();
%>
    ...
    <div title="center" region="center" style="border:0;">
	    ...
	    <div class="mini-fit" >
		    ...
		    <div id="datagrid1" class="mini-datagrid"  style="width:100%;height:100%;"  allowResize="true"
		      url="<%=request.getContextPath() %>/dcwj/dcwjitem/getList.do?topicid=<%=topicid %>&subtopicid=<%=subtopicid %>" idField="id" multiSelect="true" 
	...
	function add() {
        ...
        mini.open({
            ...
            onload: function () {
                ...
                var data = { action: "new",topicid:"<%=topicid%>",subtopicid:"<%=subtopicid%>"};
    ...
    function addSubTopic(){
    	var row = grid.getSelected();
           ...
           mini.open({
               ...
               onload: function () {
                   var iframe = this.getIFrameEl();
                   var data = { action: "new",topicid:'<%=topicid%>',subtopicid:row.zid};
                   iframe.contentWindow.SetData(data);
               },
               ondestroy: function (action) {
                   grid.reload();
