...
<div class="mini-layout" style="width:100%;height:100%;">
    <div title="center" region="center" style="border:0;">
	    ...
	    <div class="mini-fit" >
		    ...
		    <div id="datagrid1" class="mini-datagrid"  style="width:100%;height:100%;"  allowResize="true"
		      ...
		      url="<%=request.getContextPath() %>/hygl/lydhcall/getList.do" idField="zid" multiSelect="true" 
		    ...
		    >
		        <div property="columns">
		            ...
		            <div field="zryxm" width="150" headerAlign="center" align="center" allowSort="true" >姓名</div>
		            ...
		            <div field="zlrsj" width="150" headerAlign="center" align="center" allowSort="true" renderer="onGxsjRenderer">拨打时间</div>
		        </div>
		    </div>
	    </div>
    </div>
    ...
    function fstz() {
        ...
        if (row) {//alert(row.ZID+":"+row.ZFID);
            mini.open({
            	url: HOST_PATH + "/hygl/hytz/addUi.do",
                title: "会议通知发送", width: '95%', height: '95%',
                loadOnRefresh: true,
                onload: function () {
    ...
    function onCzRenderer(e) {
    	var html = "";
    	html += "<a class=\"mini-button\" style=\"width:60px;\" onclick=\"fstz()\">发送通知</a>";
        return html;
    }
