...
<!-- 	                        <a class="mini-button" iconCls="icon-add" onclick="add()" plain="true" tooltip="增加...">增加</a>
	    ...
	    <div class="mini-fit" >
		    ...
		    <div id="datagrid1" class="mini-datagrid"  style="width:100%;height:100%;"  allowResize="true"
		      ...
		      url="<%=request.getContextPath() %>/hygl/hyqd/getList.do" idField="zid" multiSelect="true" 
		    ...
		    >
		        <div property="columns">
		            ...
		            <div field="hyfztl.zfzmc" width="200" headerAlign="center" align="center" allowSort="true" >分组名称</div>  
		            <div field="zlrsj" width="130" allowSort="false" headerAlign="center" align="center" dateFormat="yyyy-MM-dd HH:mm:ss">签到时间</div>                                    
	...
	function add() {
		var title="会议文件添加";
        mini.open({
            url: HOST_PATH + "/hygl/hyqd/addUi.do",
    ...
    function deloneDo(){
        ...
        if (row) {//alert(row.ZID+":"+row.ZFID);
            ...
            $.ajax({
                url: HOST_URL+"/hygl/hyqd/delete.do?id="+row.zid,
    			type: 'post',
    		    dataType: 'json',
