...
<div class="mini-layout" style="width:100%;height:100%;">
    <div title="center" region="center" style="border:0;">
	    ...
	    <div class="mini-fit" >
		    ...
		    <div id="datagrid1" class="mini-datagrid"  style="width:100%;height:100%;"  allowResize="true"
		      ...
		      url="<%=request.getContextPath() %>/hygl/hywj/getList.do" idField="zid" multiSelect="true" 
		    ...
		    >
		        <div property="columns">
		            ...
		            <div field="ztitle" width="200" headerAlign="center" align="center" allowSort="true" >标题</div>
		            <div field="hyinfo.zhymc" width="200" headerAlign="center" align="center" allowSort="true" >会议名称</div>  
		            <div field="zwjlx" width="80" allowSort="false" headerAlign="center" align="center" renderer="onTypeRenderer">类型</div>   
		            <div field="zwjmc" width="150" headerAlign="center" align="center" allowSort="false">文件名</div>                          
		            <div field="zwjsize" width="100" allowSort="false" headerAlign="center" align="center" renderer="onSizeRenderer" >大小</div> 
		            <div field="zlrsj" width="130" allowSort="false" headerAlign="center" align="center" dateFormat="yyyy-MM-dd HH:mm:ss">添加时间</div>                                    
	...
	function add() {
		var title="会议文件添加";
        mini.open({
            url: HOST_PATH + "/hygl/hywj/addUi.do",
