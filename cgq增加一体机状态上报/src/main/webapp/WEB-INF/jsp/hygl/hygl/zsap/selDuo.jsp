...
<%String zhyid = request.getAttribute("zhyid").toString(); %>    
...
<body>
    ...
    <div class="mini-fit" >
	    ...
	    <div id="datagrid1" class="mini-datagrid"  style="width:100%;height:100%;"  allowResize="true"
	      url="<%=request.getContextPath() %>/hygl/zsap/getCommittee.do?isLimit=false&zhyid=<%=zhyid %>"    idField="zid" multiSelect="true"
	      showPager = "false"
	    >
	        <div property="columns">
	            <!--<div type="indexcolumn"></div>        --> 
	            <div field="zcode" width="70" headerAlign="center" align="center" allowSort="true">编号</div> 
