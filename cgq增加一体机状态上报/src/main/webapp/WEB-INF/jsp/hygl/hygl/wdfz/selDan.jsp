...
<!-- 	    </form> -->
    ...
    <div class="mini-fit" >
	    ...
	    <div id="datagrid1" class="mini-datagrid"  style="width:100%;height:100%;"  allowResize="true"
	      url="<%=request.getContextPath() %>/hygl/wdfz/getList.do?isLimit=true"    idField="zid" multiSelect="false"
	      showPager = "true"
	    >
	        <div property="columns">
	            <!--<div type="indexcolumn"></div>        --> 
	            <div field="zid" width="50" type="checkcolumn" >选择</div>    
	            <div field="zfzmc" width="80" headerAlign="center" align="center" allowSort="true" >分组名称</div>        
	            <div field="ztlyt" width="80" headerAlign="center" align="center" allowSort="true" >讨论议题</div> 
