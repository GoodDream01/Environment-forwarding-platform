...
*/ 
var points = [  
    new BMap.Point(114.543519,38.06174), new BMap.Point(114.538848,38.05958),  
    new BMap.Point(114.534104,38.059523), new BMap.Point(114.523325,38.05958),  
    new BMap.Point(114.518151,38.060092), new BMap.Point(114.518294,38.049181),  
    new BMap.Point(114.521259,38.049039)
];
...
function init() {  
    ...
    driving.search(new BMap.Point(114.543519,38.06174), new BMap.Point(114.521259,38.049039)); 
