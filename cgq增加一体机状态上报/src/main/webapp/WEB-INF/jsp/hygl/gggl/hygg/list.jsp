...
<!-- 	                        <a class="mini-button" iconCls="icon-remove" onclick="delone()" plain="true">删除</a>          -->
	    ...
	    <div class="mini-fit" >
		    ...
		    <div id="datagrid1" class="mini-datagrid"  style="width:100%;height:100%;"  allowResize="true"
		      ...
		      url="<%=request.getContextPath() %>/gggl/hygg/getList.do" idField="id" multiSelect="true" 
		    ...
		    >
		        <div property="columns">
		            ...
		            <div field="ztitle" width="260" headerAlign="center" align="center" allowSort="true" >公告标题</div>        
		            <div field="znr" width="600" headerAlign="center" align="center" allowSort="true" >公告内容</div> 
		            <div field="hyinfo.zhymc" width="300" headerAlign="center" align="center" allowSort="true" >相关会议</div> 
<!-- 		            <div field="typeCode" width="150" headerAlign="center" align="center" allowSort="true" renderer="onTypeCodeRenderer">公告时间</div>  -->
		            <div field="zisshow" width="80" headerAlign="center" align="center" allowSort="true" renderer="onStatusRenderer">是否提示</div>
<!-- 		            <div field="sort" width="80" headerAlign="center" align="center" allowSort="true" >排序</div> -->
<!-- 		            <div field="bz" width="150" headerAlign="center" align="center" allowSort="true" >备注</div>  -->
	...
	function add() {
		var title="系统公告添加";
        mini.open({
            url: HOST_PATH + "/gggl/hygg/addUi.do",
    ...
    function edit() {
        ...
        if (row) {//alert(row.ZID+":"+row.ZFID);
            mini.open({
            	url: HOST_PATH + "/gggl/hygg/addUi.do",
                title: "会议公告修改", width: 500, height: 260,
                loadOnRefresh: true,
                onload: function () {
                    var iframe = this.getIFrameEl();
    ...
    function deloneDo(){
        ...
        if (row) {//alert(row.ZID+":"+row.ZFID);
            ...
            $.ajax({
                url: HOST_URL+"/gggl/hygg/delete.do?id="+row.zid,
    			type: 'post',
    		    dataType: 'json',
