...
<!--                         <input name="znr" class="mini-textbox" style="height: 80px;width:330px;" required="true" /> -->
                    </td>
                </tr>
                <tr>
                    <td >是否提示：</td>
...
<!-- 		                /> -->
						 <input name="zists" class="mini-combobox" valueField="value" textField="text"  showNullItem="true"
		                   url="<%=request.getContextPath() %>/common/getDictItemByTypeCode.do?typeCode=<%=DictTypeEnum.PUB_HY_XTGG_TSZT %>"
		                   required="true" 
		                />
                    </td>
                </tr>
...
<!--                 </tr> -->
    ...
    function SaveData() {
        ...
        $.ajax({
            url: HOST_URL+"/gggl/xtgg/save.do",
			type: 'post',
		    dataType: 'json',
