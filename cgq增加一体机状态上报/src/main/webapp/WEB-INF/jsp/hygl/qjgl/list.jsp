...
<div class="mini-layout" style="width:100%;height:100%;">
    <div title="center" region="center" style="border:0;">
	    ...
	    <div class="mini-fit" >
		    ...
		    <div id="datagrid1" class="mini-datagrid"  style="width:100%;height:100%;"  allowResize="true"
		      ...
		      url="<%=request.getContextPath()%>/qjgl/qj/getList.do" idField="id" multiSelect="true" 
			  fitColumns="false" pageSize="20">
		        <div property="columns">
		            ...
		            <div field="zqjyy" width="120" headerAlign="center" align="center" allowSort="true"  renderer="onTypeRenderer" required="true">请假原因</div> 
		            ...
		            <div field="zshr" width="80" headerAlign="center" align="center" allowSort="true" >审核人</div>
		            <div field="zxjzt" width="150" headerAlign="center" align="center" allowSort="true" renderer="onStatusRenderer1" >销假状态</div> 
		            <div field="zxjsj" width="150" headerAlign="center" align="center" allowSort="true" renderer="onGxsjRenderer">销假时间</div> 
    ...
    function xiaojia1(){
        ...
        if (row) {   
            $.ajax({
            	url: HOST_PATH + "/qjgl/qj/xiaoJia.do?zid="+row.zid,
                dataType: 'json',
