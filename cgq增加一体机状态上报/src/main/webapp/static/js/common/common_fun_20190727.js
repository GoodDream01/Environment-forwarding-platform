 ...
 */
 var _steps1=[];
 _steps1.push({step:"1",code:"1101",name:"谋划",nameFmt:"谋划",url:"/xmdb/xmgl/xmmh/viewUi.do?zfid="});
 _steps1.push({step:"2",code:"1201",name:"签约",nameFmt:"签约",url:"/xmdb/xmgl/xmqy/viewUi.do?zfid="});
 _steps1.push({step:"3",code:"1301",name:"立项",nameFmt:"立项",url:"/xmdb/xmgl/xmlx/viewUi.do?zfid="});
 _steps1.push({step:"4",code:"1401",name:"开工前审批",nameFmt:"开工前<br/>审批",url:"/xmdb/xmgl/xmsp/viewUi.do?zfid="});
 _steps1.push({step:"5",code:"1501",name:"开工",nameFmt:"开工",url:"/xmdb/xmgl/xmkg/viewUi.do?zfid="});
 _steps1.push({step:"6",code:"1601",name:"建设",nameFmt:"建设",url:"/xmdb/xmgl/xmjs/viewUi.do?zfid="});
 _steps1.push({step:"7",code:"1701",name:"竣工",nameFmt:"竣工",url:"/xmdb/xmgl/xmjg/viewUi.do?zfid="});
 _steps1.push({step:"8",code:"1801",name:"入统",nameFmt:"入统",url:"/xmdb/xmgl/xmrt/viewUi.do?zfid="});
 _steps1.push({step:"9",code:"1901",name:"自评",nameFmt:"自评",url:"/xmdb/xmgl/xmzp/viewUi.do?zfid="});
 var _status1={"1101":"1", "1201":"2" ,"1301":"3" ,"1401":"4" ,"1501":"5", "1601":"6", "1701":"7", "1801":"8", "1901":"9"};

 function getStepsHtml(statusCode,zid){
	 var width = 300;
	 var steps = _steps1;
	 var status = _status1;
/*	 if(isHasTd && isHasTd=="无"){
	 ...
	 var html = "<div class=\"my sui-steps-round  steps-round-auto \" style=\"width:"+width+"px;;margin:5px 0px; \">";
 ...
 function openStatusDetailWin(url,title){
	 ...
	 mini.open({
     	 url: HOST_PATH + "/"+url,
         title: "项目阶段性展示-"+title, width: 1200, height: 600,
         loadOnRefresh: true,
         onload: function () {
