...
@Repository
public class CbdwxxDaoImpl extends CommonDaoImpl implements CbdwxxDaoI {
	...
	public void insert(HashMap hashMap, Connection conn) throws Exception {
		...
		String ZROLETYPE = Tools.convNull((String)hashMap.get("ZROLETYPE"));
		String ZXQBH= Tools.convNull((String)hashMap.get("ZXQBH"));
		String ZXQDW = Tools.convNull((String)hashMap.get("ZXQDW"));

		String sql= "";
		sql="insert into T_UNIT (ZID,ZCODE,ZNAME,ZTEL,ZADDRESS,ZLINKMAN,ZPASSWORD,ZTYPE,ZUNITCODE,ZSORTINDEX,ZROLETYPE,ZXQBH,ZXQDW)values(";
		sql+="?,?,?,?,?,?,?,?,?,?,?,?,?";
		sql+=")";
		...
		ps.setString(11, ZROLETYPE);
		ps.setString(12, ZXQBH);
		ps.setString(13, ZXQDW);
	...
	public void edit(HashMap hashMap, Connection conn) throws Exception {
		// TODO Auto-generated method stub
		PreparedStatement ps = null;
		...
		String sql= "";
		sql="update T_UNIT set ZCODE=?,ZNAME=?,ZTEL=?,ZADDRESS=?,ZLINKMAN=?,ZPASSWORD=?,ZTYPE=?,ZUNITCODE=?,ZSORTINDEX=?,ZROLETYPE=?,ZXQBH=?,ZXQDW=? where ZID=?";
		...
		ps.setString(3, ZTEL);
		ps.setString(4, ZADDRESS);
		ps.setString(5, ZLINKMAN);
		ps.setString(6, ZPASSWORD);
		ps.setString(7, ZTYPE);
		ps.setString(8, ZUNITCODE);
		ps.setString(9, ZSORTINDEX);
		ps.setString(10, ZROLETYPE);
		ps.setString(11, ZXQBH);
		ps.setString(12, ZXQDW);
		ps.setString(13, ZID);
	...
	public HashMap getById(String id) {
		// TODO Auto-generated method stub
		String sql = "select * from T_UNIT t where t.zid='"+id+"'";
	...
	public void del(String id, Connection conn) throws Exception {
		...
		String sql = "";
		String sqls= "";
		sql="delete from T_UNIT where ZID='"+id+"'";
	...
	public void up(String id, Connection conn) throws Exception {
		...
		String sql = "";
		String sqls= "";
		sql="update T_UNIT set zsortindex=nvl(zsortindex,0)-1 where ZID='"+id+"'";
	...
	public HashMap getByUnitcode(String zUnitcode) {
		// TODO Auto-generated method stub
		String sql = "select * from T_UNIT t where zunitcode='"+zUnitcode+"' ";
	...
	public HashMap getByUnitcode(String id, String zUnitcode) {
		// TODO Auto-generated method stub
		String sql = "select * from T_UNIT t where t.zid<>'"+id+"' and zunitcode='"+zUnitcode+"' ";
	...
	public HashMap getByCode(String zCode) {
		// TODO Auto-generated method stub
		String sql = "select * from T_UNIT t where zcode='"+zCode+"' ";
	...
	public HashMap getByCode(String id, String zCode) {
		// TODO Auto-generated method stub
		String sql = "select * from T_UNIT t where t.zid<>'"+id+"' and zcode='"+zCode+"' ";
