...
public class App
{
    ...
    {
        String productKey = "k02z5ONozK0";
        String deviceName = "device1";
        String deviceSecret = "2fb3b7b2f7a73b470a93580cdc61de81";
        ...
        try{
            ...
            String content = "{\"id\":1,\"version\":1.0,\"params\":{\"LightSwitch\":测试内容,\"sbh\":测试内容},\"LightSwitch\":\"1\"}";
